...
const learnerSafeQuiz: QuizGetResponse = {
  quiz: {
    ...
    passingRule: { kind: "percentage_threshold", thresholdPercent: 85 },
    retryPolicy: {
      maxAttempts: 3,
    ...
    questions: [
      {
        ...
        options: [
          { id: "opt-a", label: "The Vault catalog" },
          { id: "opt-b", label: "The AP renderer" },
          { id: "opt-c", label: "The tour engine" },
        ],
      },
      {
        id: "q2",
        ...
        options: [
          { id: "opt-a", label: "On tour completion" },
          { id: "opt-b", label: "On a passing pcert-l32 attempt" },
          { id: "opt-c", label: "On lesson unlock" },
        ],
      },
    ],
  },
