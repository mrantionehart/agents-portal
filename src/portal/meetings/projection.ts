...
export function pickListItem(r: Record<string, unknown>): AgentMeetingListItem {
  return {
    ...
    meeting_mode: (r.meeting_mode as string | null) ?? null,
    zoom_link: (r.zoom_link as string | null) ?? null,
...
export function pickDetail(j: Record<string, unknown>): AgentMeetingDetail {
  ...
  return {
    meeting: {
      ...
      meeting_mode: (m.meeting_mode as string | null) ?? null,
      zoom_link: (m.zoom_link as string | null) ?? null,
      meeting_location: (m.meeting_location as string | null) ?? null,
      callback_phone: (m.callback_phone as string | null) ?? null,
