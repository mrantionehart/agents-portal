    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <nav className="container flex items-center justify-between py-4">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900 hidden sm:inline">Hartfelt Portal</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/commissions" className="text-gray-600 hover:text-gray-900 font-medium">
            Commissions
          </Link>

          <Link href="/documents" className="text-gray-600 hover:text-gray-900 font-medium">
            Documents
          </Link>
