// ============================================================================
// Slice 2 Phase 3B-3.5 · Signing package status page (agent-facing)
// ============================================================================
...
//     when previous_package_id is present (this is the 3B-4 revision
//     entry point — as an internal-link affordance only; no revise action)
//
// Explicitly OUT OF SCOPE:
//   * broker approval / rejection controls
//   * audit history (blocked upstream by Vault for agents)
//   * approval notes
//   * document manifest / recipient plan rendering (3B-4 will render
//     these via the composer — this slice does not need them)
//   * V2 activation, provider integration, envelope creation
// ============================================================================
