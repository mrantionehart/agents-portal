...
const TRANSACTION_TYPES = [
  ...
  { value: 'buyer', label: 'Buyer', icon: Key, color: 'bg-red-500/10 border-red-300 text-red-400', selectedColor: 'bg-red-600 text-white border-red-600' },
  { value: 'lease', label: 'Lease', icon: Building2, color: 'bg-blue-500/10 border-blue-300 text-blue-400', selectedColor: 'bg-blue-600 text-white border-blue-600' },
  { value: 'referral', label: 'Referral', icon: Share2, color: 'bg-amber-500/10 border-amber-300 text-amber-400', selectedColor: 'bg-amber-600 text-white border-amber-600' },
  { value: 'wholesale', label: 'Wholesale', icon: Layers, color: 'bg-purple-500/10 border-purple-300 text-purple-700', selectedColor: 'bg-purple-600 text-white border-purple-600' },
  { value: 'double_close', label: 'Double Close', icon: DollarSign, color: 'bg-indigo-500/10 border-indigo-300 text-indigo-700', selectedColor: 'bg-indigo-600 text-white border-indigo-600' },
]
      ...
      <div className="flex-1 p-6 max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          <button
            ...
            className="p-2 rounded-lg hover:bg-[#1a1a2e] transition"
          >
        ...
        <div className="bg-[#0a0a0f] rounded-xl border border-[#1a1a2e] p-6 mb-6">
          <h2 className="text-base font-bold text-white mb-4">Transaction Type</h2>
        ...
        {isBrokerAdmin && agents.length > 0 && (
          <div className="bg-[#0a0a0f] rounded-xl border border-[#1a1a2e] p-6 mb-6">
            ...
            <select
              ...
              className="w-full px-4 py-2.5 border border-[#1a1a2e] rounded-lg text-sm focus:ring-2 focus:ring-[#C9A84C]/30 focus:border-[#C9A84C]/50"
            >
        ...
        <div className="bg-[#0a0a0f] rounded-xl border border-[#1a1a2e] p-6 mb-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-200 mb-1.5">Property Address *</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">City</label>
                <input
                  type="text"
                  value={form.city}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">State</label>
                <input
                  type="text"
                  value={form.state}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">ZIP</label>
                <input
                  type="text"
                  value={form.zip}
        ...
        <div className="bg-[#0a0a0f] rounded-xl border border-[#1a1a2e] p-6 mb-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-200 mb-1.5">Client Name</label>
              <input
                type="text"
        ...
        {(showBuyerSellerFields || showLeaseFields) && (
          <div className="bg-[#0a0a0f] rounded-xl border border-[#1a1a2e] p-6 mb-6">
            <h2 className="text-base font-bold text-white mb-4">Other Party</h2>
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-4">
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-1.5">Agent</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-1.5">Brokerage</label>
                  <input
                    type="text"
        ...
        <div className="bg-[#0a0a0f] rounded-xl border border-[#1a1a2e] p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">Contract Price</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full pl-7 pr-4 py-2.5 border border-[#1a1a2e] rounded-lg text-sm focus:ring-2 focus:ring-[#C9A84C]/30 focus:border-[#C9A84C]/50"
                  />
                </div>
              </div>
              {!showReferralFields && (
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-1.5">Earnest Money</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">$</span>
                    <input
                      type="number"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">Commission Rate %</label>
                <input
                  type="number"
                  step="0.1"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">Agent Split %</label>
                <input
                  type="number"
                  step="1"
            ...
            {/* GCI Preview */}
            {form.contract_price && (
              <div className="bg-[#050507] rounded-lg p-4 border border-[#1a1a2e]">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Estimated GCI</p>
                <div className="flex items-center gap-6">
                  <div>
                    <p className="text-xs text-gray-400">Gross Commission</p>
                  ...
                  <div>
                    <p className="text-xs text-gray-400">Agent Amount</p>
                  ...
                  <div>
                    <p className="text-xs text-gray-400">Brokerage Amount</p>
            ...
            {showReferralFields && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-1.5">Referral Fee %</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-1.5">Referral Party</label>
                  <input
                    type="text"
            ...
            {showWholesaleFields && (
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">Assignment Fee</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">$</span>
                  <input
                    type="number"
            ...
            {showLeaseFields && (
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1.5">Lease Term (Months)</label>
                <input
                  type="number"
        ...
        <div className="bg-[#0a0a0f] rounded-xl border border-[#1a1a2e] p-6 mb-6">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-2.5 border border-[#1a1a2e] rounded-lg text-sm focus:ring-2 focus:ring-[#C9A84C]/30 focus:border-[#C9A84C]/50 resize-none"
          />
        </div>
        ...
        <div className="flex items-center justify-between pb-10">
          <button
            onClick={() => router.push('/pipeline')}
            className="px-6 py-2.5 text-sm font-medium text-gray-400 hover:text-white transition"
          >
            Cancel
          </button>
          <button
