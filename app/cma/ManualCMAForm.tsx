...
// ============================================================================
// Manual CMA Form — Original form-based CMA generator
// ============================================================================
...
export default function ManualCMAForm() {
  ...
  const selectLeadAddress = (lead: LeadAddress) => {
    setSubject({ ...subject, address: lead.address, city: lead.city, state: lead.state || 'FL', zip: lead.zip })
    setShowDropdown(false)
    setSuggestions([])
  }
  ...
  const selectSuggestion = (s: AddressSuggestion) => {
    ...
    setSubject({
      ...subject, address: street, city, state: st || 'FL', zip: zp || '',
      beds: s.beds || subject.beds, baths: s.baths || subject.baths,
      sqft: s.sqft || subject.sqft, yearBuilt: s.yearBuilt || subject.yearBuilt,
    })
    setShowDropdown(false)
    setSuggestions([])
  }
